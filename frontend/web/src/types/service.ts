...
export const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    fullDescription: "ما در رایان توسعه سورین سامانه‌های تحت وب را بر پایه جدیدترین متدولوژی‌های فرانت‌اند و رندرینگ بهینه (SSR/SSG) پیاده‌سازی می‌کنیم. تمرکز اصلی ما بر سرعت بارگذاری بالا، تجربه کاربری (UX) استاندارد و سئوی فنی قوی است.",
    iconName: "Globe",
    features: [
  ...
  },
  {
    ...
    fullDescription: "تحویل مداوم نرم‌افزار بدون قطعی، نیازمند زیرساخت‌های حرفه‌ای DevOps است. تیم رایان توسعه سورین فرآیندهای تست، ساخت و استقرار پروژه‌های شما را اتوماتیک کرده و پایداری سرویس را تضمین می‌کند.",
    iconName: "Container",
    features: [
